...
% figure;
% plot(T_group.Time, T_group.('Sum. C.V.(V)'), 'LineWidth', 1.5);
% xlabel('Time');
% ylabel('Sum. C.V.(V)');
...
% % Plot 2: Time vs SOC(%)
% figure;
% plot(T_group.Time, T_group.('SOC(%)'), 'LineWidth', 1.5);
% xlabel('Time');
% ylabel('SOC (%)');
...
% figure;
% plot(T_group.Time, T_group.('DC Current(A)'), 'LineWidth', 1.5);
% xlabel('Time');
% ylabel('DC Current (A)');
...
% figure;
% plot(T_group.Time, T_group.('Average C.V.(V)'), 'LineWidth', 1.5);
% xlabel('Time');
...
% figure;
% plot(T_group.Time, T_group.('Average M.T.(oC)'), 'LineWidth', 1.5);
% xlabel('Time');
